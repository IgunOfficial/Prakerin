...
<div class="page">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="team">
                <figure class="team-image"><img src="{{ asset('template_front/dummy/person-1.jpg') }}" alt=""></figure>
        ...
        <div class="col-md-3">
            <div class="team">
                <figure class="team-image"><img src="{{ asset('template_front/dummy/person-2.jpg') }}" alt=""></figure>
        ...
        <div class="col-md-3">
            <div class="team">
                <figure class="team-image"><img src="{{ asset('template_front/dummy/person-3.jpg') }}" alt=""></figure>
        ...
        <div class="col-md-3">
            <div class="team">
                <figure class="team-image"><img src="{{ asset('template_front/dummy/person-4.jpg') }}" alt=""></figure>
                <h2 class="team-name">Sarah Stuart</h2>
